...
class System(auto_prefetch.Model):
    ...
    def add_control(self, catalog_key, control_id):
        """Add the Control to the System as a selected Control & return it (ElementControl)"""
    ...
    def remove_control(self, control_id):
        """Remove the Control from the System as a selected Control & return it (ElementControl)"""
