...
urlpatterns = [
    ...
    url(r'^(?P<system_id>.*)/controls/add$',                              views.system_control_add,                name="system_control_add"),
    url(r'^(?P<system_id>.*)/controls/remove/(?P<system_control_id>.*)$', views.system_control_remove,             name="system_control_remove"),
